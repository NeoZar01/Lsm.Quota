...
namespace DoE.Lsm.WF.Component.Requisitions.Tasks
{
    ...
    public sealed class Token
    {
        ...
        private readonly IRepositoryStoreManager _databaseContext;

        public Token(IRepositoryStoreManager databaseContext)
        ...
        public async Task<string> RequisitionNumber(string requisitionNo, string emisID, int term)
        {
            ...
            if (string.IsNullOrEmpty(requisitionNo))
            {
                ...
                else
                {
                    ...
                    {
                        await RequisitionNumber(requisitionNo, emisID, term);
                    }
