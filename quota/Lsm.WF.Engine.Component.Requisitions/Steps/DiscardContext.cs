...
namespace DoE.Lsm.WF.Component.Requisition.Steps
{
    ...
    public partial class DiscardContext : DiscardFactory
    {
        ...
        public override async Task<ProcessInstance> CreateStepInstanceAsync(ProcessCase request, ReadMode readType)
        {
        ...
        public override DiscardFactory CreateFlowInstance(ProcessCase request, ReadMode readType)
        {
        ...
        /// <returns></returns>
        public override DiscardFactory Start(ProcessCase payload, ReadMode TransactionRead)
        {
             return this;
        }
    }
    ...
    {
        public override Task<ProcessInstance> CreateFlowInstanceAsync(ProcessCase request, ReadMode readType)
        {
            throw new NotImplementedException();
        }
        public override DiscardFactory CreateStepInstance(ProcessCase request, ReadMode readType)
        {
            throw new NotImplementedException();
        }
