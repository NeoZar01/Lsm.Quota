...
namespace DoE.Lsm.WF.Component.Requisition.Steps
{
    ...
    public partial class DiscardContext : DiscardFactory
    {
        ...
        public override async Task<ProcessInstance> CreateStepInstanceAsync(ProcessWorkItem request, ReadMode readType)
        {
        ...
        public override DiscardFactory CreateFlowInstance(ProcessWorkItem request, ReadMode readType)
        {
        ...
        /// <returns></returns>
        public override DiscardFactory Start(ProcessWorkItem payload, ReadMode TransactionRead)
        {
             return this;
        }
    }
    ...
    {
        public override Task<ProcessInstance> CreateFlowInstanceAsync(ProcessWorkItem request, ReadMode readType)
        {
            throw new NotImplementedException();
        }
        public override DiscardFactory CreateStepInstance(ProcessWorkItem request, ReadMode readType)
        {
            throw new NotImplementedException();
        }
