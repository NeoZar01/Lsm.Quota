...
namespace DoE.Lsm.WF.WI.Api
{
    ...
    public interface INormsStandardManager
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        Task<ProcessRequestModelProxy> ValidateProcessTokenAsync(string requestToken, ProcessRequestModelProxy processRequestModel, IProcessQueueWorker processQueueWorker);
